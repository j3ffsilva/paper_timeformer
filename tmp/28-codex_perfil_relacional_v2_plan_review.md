...
O plano abaixo implementa `docs/12-novo_perfil_relacional.md`, que define:
...
O documento completo está em `docs/12-novo_perfil_relacional.md` (789 linhas);
...
6. A Fase 1 muda a definição de centralização (μ_t global vs. média das
   ...
   `docs/05-relational_change_current_plan.md`, exigindo reinterpretação.
...
8. Há riscos de identificabilidade/vazamento análogos aos já descobertos na
   tentativa anterior de "bairros semânticos" (`tmp/21-claude_semantic_neighborhood_plan_review.md`)
