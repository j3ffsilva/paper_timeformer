# Prompt para codex: auditoria do "no-go" da Fase 1.5 (decomposição em modos espectrais, §7-9 de novo_perfil_relacional.md)

## Contexto

Estamos implementando o "Perfil Relacional v2" descrito em
`docs/novo_perfil_relacional.md` (documento canônico, 813 linhas). Antes de
...
- `docs/novo_perfil_relacional.md` (documento canônico completo)
