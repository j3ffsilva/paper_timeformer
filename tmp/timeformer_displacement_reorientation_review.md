...
2. Documentar formalmente os resultados do `set_ssl` em `docs/synthetic_results_current.md` (atualmente ausentes nas tabelas formais — identificado na revisão anterior).
...
**Objetivo:** reescrever `docs/novo_planejamento.md` com a nova proposta validada empiricamente.
