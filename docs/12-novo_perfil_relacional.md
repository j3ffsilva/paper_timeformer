...
`docs/14-perfil_relacional_v2_resultados_fase1.md` §2 (variante "D").
...
`docs/14-perfil_relacional_v2_resultados_fase1.md` §7.14-7.19.
...
`docs/14-perfil_relacional_v2_resultados_fase1.md` §3, §7.1-7.21): o
