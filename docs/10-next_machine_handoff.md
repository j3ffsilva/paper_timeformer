...
Formalização completa em `docs/09-relational_profile_formalization.md`.
...
docs/09-relational_profile_formalization.md          # formalização matemática
docs/05-relational_change_current_plan.md            # plano e resultados anteriores
```
